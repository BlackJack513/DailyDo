  ...
  >
    ...
    <div class="flex items-center gap-0.5">
      <button
        ...
        class="p-1 rounded-lg hover:bg-surface-tertiary text-content-tertiary hover:text-content transition-colors"
      >
      ...
      <button
        ...
        class="p-1 rounded-lg hover:bg-red-50 hover:bg-red-50/20 text-content-tertiary hover:text-red-500 transition-colors"
      >
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            stroke-linecap="round"
