...
>
 ...
 <!-- Footer -->
 <div class="flex items-center justify-between px-5 py-3.5 border-t border-divider bg-surface-2/80 bg-surface/80 rounded-b-2xl">
 <button
 @click="$emit('expand')"
...
>
 ...
 <button @click="$emit('close')" class="px-3.5 py-1.5 rounded-lg text-sm text-muted hover:bg-surface-2 transition-colors">
 取消
 </button>
