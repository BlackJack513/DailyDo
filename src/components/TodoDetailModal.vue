  ...
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center" @click.self="$emit('close')">
        ...
        <!-- Modal -->
        <div
          class="relative w-full max-w-xl mx-4 bg-surface rounded-2xl shadow-2xl border border-divider overflow-hidden animate-in"
        >
          <!-- Header -->
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :class="
                      step.completed ? 'bg-green-500 border-green-500' : 'border-divider group-hover:border-primary'
                    "
                  >
          ...
          <!-- Footer -->
          <div
            class="flex items-center justify-between px-6 py-3.5 border-t border-divider bg-surface-2/80 bg-surface/80"
          >
    ...
    <Transition name="toast">
      <div
        v-if="toast.show"
        class="fixed bottom-8 left-1/2 -translate-x-1/2 z-[60] px-4 py-2.5 rounded-xl shadow-lg text-sm font-medium flex items-center gap-2 pointer-events-none"
        :class="
          toast.type === 'success'
