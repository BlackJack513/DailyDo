...
>
 ...
 <div v-if="pendingTodos.length> 0" class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-surface-tertiary text-content-secondary text-muted text-xs font-medium">
...
>
 ...
 <div class="flex gap-2">
 <button @click="showAddForm = false" class="px-4 py-1.5 rounded-lg text-xs text-content-tertiary hover:bg-surface-tertiary transition-colors">取消</button>
