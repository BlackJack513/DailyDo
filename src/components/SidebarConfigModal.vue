<template>
 ...
 <div class="relative bg-surface rounded-2xl shadow-2xl border border-border w-[380px] max-h-[80vh] flex flex-col">
 <!-- Header -->
 ...
 <button @click="handleClose" class="p-1.5 rounded-lg hover:bg-surface-tertiary text-content-tertiary hover:text-content transition-colors">
 ...
 :class="[ dragState && dragState.index === index ? 'opacity-40 border-dashed border-primary/40 bg-primary/5' : 'border-border bg-surface-secondary hover:border-primary/20', dragHoverIndex === index ? 'ring-2 ring-primary/30' : '' ]"
>
 <!-- Drag handle -->
 <div
...
></span>
 ...
 <button @click="resetDefault" class="text-xs text-content-tertiary hover:text-primary transition-colors">
 恢复默认
 </button>
 <div class="flex gap-2">
 <button @click="handleClose" class="px-4 py-1.5 rounded-lg text-sm text-content-tertiary hover:bg-surface-tertiary transition-colors">
 取消
 </button>
...
>
 <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl border-2 border-primary bg-surface shadow-2xl min-w-[260px]">
 ...
 <span class="flex-shrink-0 w-9 h-5 rounded-full flex items-center px-0.5" :class="dragState.item.visible ? 'bg-primary' : 'bg-control'">
 <span class="w-4 h-4 rounded-full bg-surface shadow-sm" :class="dragState.item.visible ? 'ml-auto' : ''"></span>
 </span>
 </div>
 </div>
 </div>
