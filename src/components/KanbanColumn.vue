...
>
 ...
 :class="[ todo.steps && todo.steps.length > 0 ? 'p-4' : 'p-3', { 'opacity-40': dragState && dragState.todo.id === todo.id, 'opacity-60': todo.status === 'done', 'cursor-grab': !dragState || dragState.todo.id !== todo.id } ]"
>
 <!-- Status toggle -->
 <button
...
>
 ...
 <span v-if="todo.recurrence_type && todo.recurrence_type !== 'none'" class="text-xs text-content-tertiary flex items-center gap-0.5">
...
>
 ...
 <button @click.stop="$emit('edit', todo)" class="p-1.5 rounded-lg hover:bg-surface-tertiary text-content-tertiary hover:text-content transition-colors">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
 </svg>
 </button>
 <button @click.stop="$emit('delete', todo)" class="p-1.5 rounded-lg hover:bg-red-50 hover:bg-red-50/20 text-content-tertiary hover:text-red-500 transition-colors">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
>
 <div class="flex items-start gap-3 p-3 rounded-xl border-2 border-primary bg-surface shadow-2xl min-w-[250px] max-w-[320px]">
