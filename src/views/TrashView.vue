...
>
 ...
 <!-- Empty -->
 <div v-if="store.trashTodos.length === 0" class="flex flex-col items-center justify-center h-64 text-content-tertiary">
...
>
 ...
 <p class="text-sm text-content-secondary text-muted mb-4">确定要永久删除「{{ deletingTodo.title }}」吗？此操作不可撤销。</p>
 ...
 <p class="text-sm text-content-secondary text-muted mb-4">确定要清空回收站中的所有 {{ store.trashTodos.length }} 个项目吗？此操作不可撤销。</p>
 <div class="flex justify-end gap-3">
