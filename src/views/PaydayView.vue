  ...
  <div class="h-full flex flex-col relative overflow-hidden bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
    ...
    <div class="relative z-20 flex-1 flex flex-col items-center justify-center px-8 py-12">
      ...
      <div class="flex flex-wrap justify-center gap-4 mb-8 w-full max-w-xl">
        ...
        <div
          v-if="!isPayday"
          class="flex-1 min-w-[200px] bg-surface/80 backdrop-blur rounded-2xl shadow-lg border border-amber-200 border-divider px-6 py-5 text-center"
        >
          ...
          <p class="text-xs text-content-tertiary mt-2">每月 {{ paydayDay }} 号发工资</p>
        </div>

        <!-- Payday celebration card -->
        <div
          v-else
          class="flex-1 min-w-[200px] bg-surface/80 backdrop-blur rounded-2xl shadow-lg border border-green-200 border-divider px-6 py-5 text-center"
        >
          <p class="text-xl font-bold text-green-500 mb-1">今天就是发薪日！</p>
          <p class="text-xs text-content-secondary text-muted">辛苦了一个月，劳自己吧</p>
        </div>

        <!-- Rest day countdown card -->
        <div
          class="flex-1 min-w-[200px] bg-surface/80 backdrop-blur rounded-2xl shadow-lg border border-blue-200 border-divider px-6 py-5 text-center"
        >
          <div class="flex items-center justify-center gap-1.5 mb-2">
